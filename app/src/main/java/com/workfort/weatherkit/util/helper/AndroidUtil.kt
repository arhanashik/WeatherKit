...
class AndroidUtil {
    ...
    fun getKeyHash() {
        try {
            val info = WeatherKitApp.getApplicationContext().packageManager
                .getPackageInfo(WeatherKitApp.getApplicationContext().packageName, PackageManager.GET_SIGNATURES)
